...
print('Loading list of enroll ivectors from ' + str(enroll_scp_list))

print('Loading enroll ivectors ' + str(enroll_scp_list))
...
print('Saving score matrix to ' + str(out_file))
